...
- **AS3 / Flash 7.0 client**, built to a `WebMain.swf` and played in the standalone **Adobe Flash Projector** (Ruffle can't do RotMG's raw TCP sockets — yet).
...
**Why Flash in 2026?**
The original RotMG client is AS3/Flash and uses raw TCP sockets that Ruffle doesn't emulate yet. The standalone Flash Projector still runs it perfectly. A modern client is a long-term maybe, not a blocker.
