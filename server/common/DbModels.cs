...
namespace common
{
    ...
    public class DbChar : RedisObject
    {
        ...
        // ROTF Runes (Phase D2): per-character rune slots, JSON-serialized
        public string RuneData
        {
            get { return GetValue<string>("runeData"); }
            set { SetValue<string>("runeData", value); }
        }
    }
