...
namespace wServer.realm.entities.vendors
{
    ...
    internal static class MerchantLists
    {
        ...
        {
            { TileRegion.Store_1, new Tuple<List<ISellableItem>, CurrencyType, int>(Store1, CurrencyType.Fame, 0) }, // ROTF: all shops use Fame (no gold)
            { TileRegion.Store_2, new Tuple<List<ISellableItem>, CurrencyType, int>(Store2, CurrencyType.Fame, 0) },
            { TileRegion.Store_3, new Tuple<List<ISellableItem>, CurrencyType, int>(Store3, CurrencyType.Fame, 0) },
        ...
        static void InitDyes(RealmManager manager)
        {
            ...
            Shops[TileRegion.Store_5] = new Tuple<List<ISellableItem>, CurrencyType, int>(d1, CurrencyType.Fame, 0); // ROTF: Fame, not gold
            Shops[TileRegion.Store_6] = new Tuple<List<ISellableItem>, CurrencyType, int>(d2, CurrencyType.Fame, 0); // ROTF: Fame, not gold
        }
    }
}