...
namespace wServer.realm.entities
{
    ...
    public partial class Player : Character, IContainer, IPlayer
    {
        ...
        public RuneEquipment Runes { get; set; } = new RuneEquipment(); // ROTF Runes (D2)
        ...
        public void SaveToCharacter()
        {
            ...
            chr.RuneData = Runes.ToJson(); // ROTF Runes (D2)
        }
            ...
            : base(client.Manager, client.Character.ObjectType)
        {
            ...
            SlotTypes = Utils.ResizeArray(
                ...
                20);
            Runes = RuneEquipment.FromJson(Client.Character.RuneData); // ROTF Runes (D2) — before Stats (Boost reads it)
