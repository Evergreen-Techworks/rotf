...
namespace wServer.logic
{
    partial class BehaviorDb
    {
        private _ Abyss = () => Behav()
            ...
            .Init("Archdemon Malphas",  // arena: large circular boss chamber (~70% dungeon width), brown/sandy Abyss tiles, corridors from north — DOCUMENTED-from-minimap disc_rUsOS8maIww:00100
                new State(
                    ...
                    new State("he_is_never_alone",
                        new Taunt("I have been released..."),                          // ROTF recovered taunt arc (disc_p-f3qDjrVDY)
                        new Taunt(0.0014, "Kill my proteges, and you will regret it..."), // DESIGNED-no-footage (invented flavor; not in any recovery spec)
                        new Taunt(0.0014, "My minions will slay you!"), // VERIFIED disc_SXgeJh2Ao6U (spec-documented)
                        new Taunt(0.0016, "My minions are failing me! I will..."), // VERIFIED-partial disc_SXgeJh2Ao6U (distinct mid-fight line; on-screen text cut)
                        new Taunt(0.0010, "I have been defeated... My demons will crush you!"), // VERIFIED disc_NsKbqLJgUfA (boss-colored chat)
            ...
            // EPIC ARCHDEMON MALPHAS — ROTF epic variant of base Malphas. EpicBosses/ f_00100 confirms boss + 3 taunts
            // (chat_00025 with "Epic Archdemon Malphas:" prefix explicit). 150k HP. Protector summon → solo phase.
            .Init("Epic Archdemon Malphas",
                new State(
                    new State("idle", new PlayerWithinTransition(14, "protect")),
                    new State("protect",
                        new Taunt("Kill my protectors before you can face me!"), // VERBATIM EpicBosses chat_00025
                        new Taunt(0.0018, "My minions will slay you!"),           // VERBATIM EpicBosses f_00100
                        new Flash(0xcc0000, 0.3, 8),
                        new Prioritize(new StayCloseToSpawn(0.2, 7), new Wander(0.25)),
                        new Shoot(14, count: 8, shootAngle: 45, coolDown: 900),
                        new Shoot(14, projectileIndex: 1, count: 3, shootAngle: 20, predictive: 0.5, coolDown: 1600),
                        new Spawn("Malphas Flamer", maxChildren: 3, initialSpawn: 0.75, coolDown: 8000),
                        new EntityNotExistsTransition("Malphas Flamer", dist: 25, targetState: "solo")
                    ),
                    new State("solo",
                        new Taunt("My minions are failing me! I will destroy you!"), // VERBATIM-partial EpicBosses f_00100 (right-edge cut after "destroy")
                        new Flash(0xff3300, 0.25, 12),
                        new Prioritize(new Wander(0.45)),
                        new Shoot(14, count: 14, shootAngle: 25, coolDown: 700),
                        new Shoot(14, projectileIndex: 1, count: 5, shootAngle: 18, predictive: 0.6, coolDown: 1100)
                    )
                ),
                new Threshold(0.1,
                    new ItemLoot("Demon Blade", 0.06),
