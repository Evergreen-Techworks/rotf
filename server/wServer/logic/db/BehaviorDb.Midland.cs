// MECH-LOOP: Midland dungeon — Dwarf King boss chamber: large circular/octagonal room, red/crimson large stone tiles with dark grid seam lines, thick dark gray walls. DOCUMENTED-from-frames disc_fjgne_X74s8 f_00190 (floor + fight) + minimap_00030/00040/00050 (circular chamber shape).
...
namespace wServer.logic
{
    partial class BehaviorDb
    {
        private _ Midland = () => Behav()
            ...
            .Init("Dwarf King",  // arena: Midland dungeon — large circular/octagonal boss chamber; floor: red/crimson large stone tiles with dark grid seam lines; thick dark gray walls. DOCUMENTED-from-frames disc_fjgne_X74s8 f_00190 + minimap_00030/00040/00050
                new State(
                    ...
                    new State("Engaging",
                        new Taunt(0.2, "You'll taste my axe!"),     // VERIFIED-2x-spec (disc_PRzNeGfRR00 + disc_TkraL4lSyDw — DOCUMENTED VERBATIM in 2 independent recoveries, both attributing it to Dwarf King + axe-melee)
                        new Taunt(0.12, "Tasted? Again!"),          // ROTF recovery (disc_fjgne_X74s8): base Dwarf King IS the ROTF boss
                        new Taunt(0.12, "Anyone! Anyone!!"),        // UNVERIFIABLE-illegible (single source disc_fjgne_X74s8; chat dense/compressed, line not relocatable in this fire's frame reads -> kept but flagged unconfirmed)
                        new Prioritize(
                            new Follow(1.0, acquireRange: 15, range: 1),
                            new Wander(0.4)
                            ),
            ...
            // MECH-LOOP 2026-06-24: attacks PARTIAL — disc_kZl_YV0-aVQ f_02806/f_02807: small ROUND WHITE projectile dots
            // confirmed in green-realm arena around Drake Baby entity. Chat f_02807: "Christie: drake baby has just spawned!"
            // confirms this is the Drake Baby fight. White round dots scattered in realm arena consistent with Shoot(8) single
            // shot (radius 8 tiles); Horned Drake fires simultaneously so multi-dot coverage from both entities. Bullet SHAPE
            // = small round/spherical white dot CONFIRMED. coolDown:1500 RECONSTRUCTED. attacks_status: no-footage → partial.
            .Init("Drake Baby",  // attacks PARTIAL disc_kZl_YV0-aVQ f_02806/f_02807: small ROUND WHITE bullet dots CONFIRMED; coolDown RECONSTRUCTED. Arena: open REALM event — green grass/trees biome; DOCUMENTED disc_kZl_YV0-aVQ f_02790 (spawn chat) + f_02795
                new State(
                    new State("unharmed",
                        new Shoot(8, coolDown: 1500),  // small round white bullet PARTIAL f_02806/f_02807; coolDown RECONSTRUCTED
                        new State("wander",
                            new Prioritize(
                                new StayAbove(0.8, 60),
                                new Wander(0.8)
                    ...
                    new State("call_mama",
                        ...
                        new State("get_close_to_mama",
                            new Taunt("Awwwk! Awwwk!"), // VERIFIED disc_MBGeRlSnKqM (footage-grounded — boss-coloured "Drake Baby:" chat, verbatim "Awwwk! Awwwk!" + green-flash radial-ring attack; CORRECTS the prior DESIGNED-no-footage label — this line IS in the footage)
                        ...
                        new State("cry_for_mama",
                            new Taunt("Awwwwk! Awwwwk!"), // VERIFIED disc_kZl_YV0-aVQ (footage-grounded — entity-coloured chat, verbatim 4-w "Awwwwk! Awwwwk!"; the louder escalated cry-for-mama squawk)
                            new StayBack(0.65, 8),
            ...
            // MECH-LOOP 2026-06-24: attacks NO-FOOTAGE — no source tags; not found in any recovery spec.
            // Attacks (Shoot(8) + enrage ChangeSize/Flash + GRRRRAAGH! taunt) are fully DESIGNED/RECONSTRUCTED.
            .Init("Desert Werewolf",
                new State(
                    ...
                    new State("enraged",
                        new Shoot(8, projectileIndex: 0, predictive: 0.3, coolDown: 1000, coolDownOffset: 500),
                        new Taunt(0.7, "GRRRRAAGH!"), // DESIGNED-no-footage (invented werewolf enrage roar; no recovery source — flavor for the enrage/grow phase, honestly labeled)
