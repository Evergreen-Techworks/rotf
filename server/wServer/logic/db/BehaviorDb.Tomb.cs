        ...
        private _ Tomb = () => Behav()
            ...
            .Init("Tomb Support",
                new State(
                    ...
                    new State("weakning",
                        new Orbit(.6, 5, target: "Tomb Boss Anchor", radiusVariance: 0.5),
                        new Taunt("Impudence! I am an immortal. I needn't take you seriously."), // CORRECTED disc_OROH0lDrGTg f_00855: <Nut>: "...I needn't take you seriously." (was "your" typo; comma→period confirmed from disc)
