            ...
            .Init("Septavius the Ghost God",
                new State(
                    ...
                    new State(
                        ...
                        new Taunt(0.5, "I am weak... I cannot stay immortal forever!"), // recovered verbatim (immortal->vulnerable cycle)
                        new Taunt(0.0016, "I have failed... you release a..."), // VERIFIED-partial ShatteredLoot (defeat line; on-screen text cut)
                        new Wander(0.1),
                    ...
                    new State("spiral",
                        new Taunt("Hahaha! How about a few grenades?!"), // recovered verbatim
                    ...
                    new State("ring",
                        new Taunt("Enough! You shall not survive another wave of my deadly attacks!"), // recovered verbatim
                        new Wander(0.1),
                        new Shoot(10, 12, projectileIndex: 4, coolDown: 2000),
                        new TimedTransition(10000, "transition3")
                        ),
                    new State("quiet",
                        new Taunt("I... will... destroy you!"), // recovered verbatim
                        new Wander(0.1),
                    ...
                    new State("spawn",
                        new Taunt("My minions will crush you!"), // recovered verbatim
                        new Taunt(0.0016, "My two children shall handle you themselves!"), // VERIFIED ShatteredLoot (full line from frames; prior build truncated)
                        new Taunt(0.0016, "My minions have betrayed me... I will handle you myself!"), // VERIFIED ShatteredLoot (full line; prior build truncated)
                        new Taunt(0.0001, "I have failed... you release great evil upon the realm!"), // RECONSTRUCTED-partial Asgard scan (death-frame; last word 'realm'/'fallen' unresolved)
                        new Wander(0.1),
