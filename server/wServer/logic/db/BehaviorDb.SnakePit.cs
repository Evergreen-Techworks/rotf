            ...
            .Init("Stheno the Snake Queen",
                new State(
                    ...
                    new State("Silver Blasts",
                        // ROTF gave base-game Stheno custom taunts. VERIFIED-partial disc_Yx0kTFEixbA:
                        // spot-checked the chat frames — speaker prefix "Stheno the Snake Queen:" confirmed
                        // (also an "Epic Stheno the Snake Queen" variant). Lines are right-edge TRUNCATED in
                        // the capture, so these are grounded STEMS (the trailing "..." is the cut, not flavor).
                        new Taunt(0.0016, "And so..."),   // VERIFIED-partial disc_Yx0kTFEixbA (truncated)
                        new Taunt(0.0016, "I cannot..."), // VERIFIED-partial disc_Yx0kTFEixbA (truncated; distinct from Marble Colossus's "I CANNOT FAIL")
                        new Taunt(0.0016, "Please..."),   // VERIFIED-partial disc_Yx0kTFEixbA (truncated)
                        new Taunt(0.0016, "Watch..."),    // VERIFIED-partial disc_Yx0kTFEixbA (truncated; frame shows "Watch m...")
